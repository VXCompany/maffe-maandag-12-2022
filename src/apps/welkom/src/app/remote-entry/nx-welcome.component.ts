    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div>
          ...
          <p>&nbsp;</p>
          <p>
            Aris heeft er al 1 voor je opgespind in de cloud. Gebruik die!
            Ze staan hier:
          </p>
          <ul>
            <li>Voor team 1: https://api1.maffe-maandag.nl</li>
            <li>Voor team 2: https://api2.maffe-maandag.nl</li>
            <li>Voor team 3: https://api3.maffe-maandag.nl</li>
          </ul>
          <p>
            S.v.p. zorgen dat in jullie build naar deze urls gerefereerd wordt.
...
<br />
        ...
        <div>
          ...
          <p>
            Zo maak je een micro-frontend project
...
nx serve myhostapp --devRemotes=mymicrofrontend
          ...
          <p>
            ...
            Open de netwerk-tab als je rondklikt. Kijk vooral waar RemoteEntry.mjs vandaan komt.. 
            Je zult zien dat die op een andere port draait.
          </p>
        </div>
